...
Config: ~/.config/antigravity-seo/dataforseo-costs.json
Ledger: ~/.config/antigravity-seo/dataforseo-ledger.json
...
Security fixes: config path corrected to ~/.config/antigravity-seo/
"""
...
# ----- paths -----
CONFIG_DIR = Path.home() / ".config" / "antigravity-seo"
LEGACY_CONFIG_DIR = Path.home() / ".config" / "antigravity-seo"
