#!/usr/bin/env python3
"""
Normalize DataForSEO API responses for consistent consumption by antigravity-seo skills.
...
def main():
    parser = argparse.ArgumentParser(
        description="Normalize DataForSEO API responses for antigravity-seo skills"
    )
