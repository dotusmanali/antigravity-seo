...
def build_prompt(request: str) -> str:
    ...
    return (
        "You are operating inside the antigravity-seo repository on Windows from the repo root. "
...
def main() -> None:
    """CLI entry point."""
    parser = argparse.ArgumentParser(description="Probe provider command selection for antigravity-seo workflows")
