#!/usr/bin/env python3
"""
Probe an OpenAI-compatible Responses API provider for Antigravity-style readiness.
...
def main() -> None:
    """CLI entry point."""
    parser = argparse.ArgumentParser(description="Probe an OpenAI-compatible Responses provider for Antigravity-style readiness")
