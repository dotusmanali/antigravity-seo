#!/usr/bin/env python3
"""
Moz Link Explorer API client for Antigravity SEO.
...
RATE_LIMIT_DELAY = 10
RATE_LIMIT_FILE = os.path.expanduser("~/.cache/antigravity-seo/moz_last_request.lock")
LEGACY_RATE_LIMIT_FILE = os.path.expanduser("~/.cache/antigravity-seo/moz_last_request.lock")
...
def _moz_request(method: str, params: dict, api_key: str) -> dict:
    ...
    headers = {
        ...
        "x-moz-token": api_key,
        "User-Agent": "AntigravitySEO/1.8.0",
    }
...
def main():
    parser = argparse.ArgumentParser(
        description="Moz Link Explorer API client for Antigravity SEO"
    )
    parser.add_argument(
        "command",
