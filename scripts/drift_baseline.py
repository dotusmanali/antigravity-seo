...
Storage: ~/.cache/antigravity-seo/drift/baselines.db
"""
...
DB_DIR = os.path.expanduser("~/.cache/antigravity-seo/drift")
LEGACY_DB_DIR = os.path.expanduser("~/.cache/antigravity-seo/drift")
DB_PATH = os.path.join(DB_DIR, "baselines.db")
LEGACY_DB_PATH = os.path.join(LEGACY_DB_DIR, "baselines.db")


def drift_db_path() -> str:
    """Use the Antigravity drift DB, or read an existing legacy DB if no Antigravity DB exists."""
