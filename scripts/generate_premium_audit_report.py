...
def derive_report_filenames(audit_dir: Path, canonical_url: str, report_md: str) -> tuple[str, str]:
    ...
    base_name = f"antigravity-seo-audit-{domain_slug}-{date_slug}"
  ...
  <div class="page">
    <section class="cover">
      <div class="cover-card">
        ...
        <p class="subhead">A professional HTML and PDF report for {domain}, built from the completed Antigravity SEO audit with inline evidence, charts, screenshots, and a print-safe structure.</p>
