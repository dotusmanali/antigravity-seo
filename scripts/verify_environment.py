#!/usr/bin/env python3
"""
Verify that the local environment is ready to run Antigravity SEO headlessly.
...
DEFAULT_USER_AGENT = (
    "Mozilla/5.0 (compatible; AntigravitySEOHeadless/1.0; "
...
def check_writable(path: Path) -> dict[str, Any]:
    ...
    try:
        ...
        probe = path / ".antigravity-seo-write-test"
...
def main() -> int:
    """CLI entry point."""
    parser = argparse.ArgumentParser(description="Verify local environment for Antigravity SEO headless workflows")
    ...
    print("Antigravity SEO Environment Verification")
    print("=" * 40)
