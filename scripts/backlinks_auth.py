#!/usr/bin/env python3
"""
Backlink API credential management for Antigravity SEO.
...
CONFIG_PATH = os.path.expanduser("~/.config/antigravity-seo/backlinks-api.json")
LEGACY_CONFIG_PATH = os.path.expanduser("~/.config/antigravity-seo/backlinks-api.json")
CACHE_DIR = os.path.expanduser("~/.cache/antigravity-seo/commoncrawl")
LEGACY_CACHE_DIR = os.path.expanduser("~/.cache/antigravity-seo/commoncrawl")
...
def load_config() -> dict:
    ...
    Reads ~/.config/antigravity-seo/backlinks-api.json first. Any missing fields
    ...
    # Load from Antigravity config, with read-only fallback for old Antigravity SEO installs.
...
Free backlink data sources for Antigravity SEO. No payment required for any of these.
...
def main():
    parser = argparse.ArgumentParser(
        description="Backlink API credential management for Antigravity SEO"
    )
    parser.add_argument(
        "--check",
        nargs="?",
