#!/usr/bin/env python3
"""
Bootstrap a Antigravity SEO runtime for headless CLI/API execution.

Usage:
    python scripts/bootstrap_environment.py --json
    python scripts/bootstrap_environment.py --venv .antigravity-seo-venv --json
...
DEFAULT_VENV = ROOT / ".antigravity-seo-venv"
OUTPUT_LIMIT = 12000
...
def main() -> int:
    """CLI entry point."""
    parser = argparse.ArgumentParser(description="Bootstrap a Antigravity SEO runtime environment")
