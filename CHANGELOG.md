agy --dangerously-skip-permissions# Changelog

## [1.9.6+antigravity.5] - 2026-04-28
...
- Updated public install refs to `v1.9.6-antigravity.5` so users receive the macOS Python 3.14 bootstrap fix from `main`.

## [1.9.6+antigravity.1] - 2026-04-27
...
- Installers default to `https://github.com/dotusmanali/antigravity-seo`.
- New credentials and runtime caches use `~/.config/antigravity-seo/` and `~/.cache/antigravity-seo/`.
- Legacy `~/.config/antigravity-seo/` and `~/.cache/antigravity-seo/` files are read only as migration fallback.
- Community footer is config-gated and disabled by default for Antigravity/API/client deliverables.
