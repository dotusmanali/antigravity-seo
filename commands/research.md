---
name: research
description: "Understand the opportunity: keyword demand, SERP intent, competitors, content gaps, and site/topic/entity maps. Not sure? Use /seo:auto."
...
- Discover search demand, SERP intent, topic clusters, and content opportunities; keep AI-answer-inclusion diagnosis in `/seo:audit --visibility`.
...
- Keep evidence mode visible (tool vs. estimate); hand off to `/seo:create` for production.
