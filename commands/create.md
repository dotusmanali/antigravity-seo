---
name: create
description: "Produce SEO/GEO content end-to-end: brief, draft one asset or a series, refresh stale content, and prepare a CMS-neutral publish package. Not sure? Use /seo:auto."
...
- Do not claim publish-ready status without `/seo:audit` or `--publish` quality-gate evidence.
