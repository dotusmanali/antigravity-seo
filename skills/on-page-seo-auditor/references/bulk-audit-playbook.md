...
Referenced from [SKILL.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/on-page-seo-auditor/SKILL.md). Use when the user wants on-page audits across >5 pages at once.
