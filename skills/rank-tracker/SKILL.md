...
- **Primary next skill**: [alert-manager](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/alert-manager/SKILL.md) when recurring monitoring should become automated.
...
> **Reference**: See [Ranking Analysis Templates](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/rank-tracker/references/ranking-analysis-templates.md) for the complete output templates for all seven steps.
...
> **Reference**: See [Tracking Setup Guide](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/rank-tracker/references/tracking-setup-guide.md) for tracking setup, root-cause taxonomy, CTR benchmarks, SERP feature impact, and algorithm-update assessment.
...
- [Tracking Setup Guide](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/rank-tracker/references/tracking-setup-guide.md) — Setup rules, feature tracking, and interpretation guidance

## Next Best Skill

Initial setup (no baseline) → [alert-manager](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/alert-manager/SKILL.md). Subsequent runs (baseline exists) → Terminal. Visited-set rule applies per [skill-contract.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/references/skill-contract.md).
