...
|-------|-------|-----------|
| `FIRECRAWL_API_KEY not set` | MCP not configured | Check `mcp_config.json` and set `FIRECRAWL_API_KEY` env var |
...
3. Configure Firecrawl: Check `mcp_config.json` and set `FIRECRAWL_API_KEY` env var
