...
Strategy planning should consider the FLOW 5-surface model (owned site, SERP plus AI Overviews, AI assistant citations, local pack, communities and video). Local-pack work is delegated to `antigravity-seo`; everything else lives inside antigravity-blog. Full mapping in `skills/blog/references/flow-alignment.md`.
...
- AI referral traffic (GA4: source contains chatgpt, perplexity, antigravity)
