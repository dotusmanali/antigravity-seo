...
Referenced from [SKILL.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/technical-seo-checker/SKILL.md). Use as a compact output model, not as fixed data.
