...
Referenced from [SKILL.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/technical-seo-checker/SKILL.md). Use when the user is planning a migration (platform, domain, URL structure, or framework change) and needs an audit + risk assessment before the change ships.
