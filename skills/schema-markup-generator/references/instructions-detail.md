...
> **Reference**: See [references/schema-templates.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/schema-markup-generator/references/schema-templates.md) for copy-start JSON-LD templates.
