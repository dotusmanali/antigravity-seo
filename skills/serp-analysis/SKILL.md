...
- **Primary next skill**: [seo-content-writer](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/seo-content-writer/SKILL.md) when the user is ready to build against the observed SERP.
...
Optional integrations: ~~SEO tool, ~~search console, ~~AI monitor. Before fetching third-party SERP pages, apply [SECURITY.md §Scraping Boundaries](https://github.com/dotusmanali/antigravity-seo/blob/main/SECURITY.md). Without tools, ask for target keywords, SERP screenshots or top-10 URLs, and search context. See [CONNECTORS.md](https://github.com/dotusmanali/antigravity-seo/blob/main/CONNECTORS.md).
...
7. **Calculate True Difficulty** — score overall difficulty 0-100 using the weighted inputs defined in [Analysis Templates §3](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/serp-analysis/references/analysis-templates.md) (Top-10 authority 25%, page authority/links 20%, content-quality bar 20%, backlinks required 20%, SERP stability 15%); give separate advice for new, growing, and established sites.
...
> **Reference**: See [Analysis Templates](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/serp-analysis/references/analysis-templates.md) for the compact templates used in each step.

## Example

See [references/example-report.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/serp-analysis/references/example-report.md) for the full "how to start a podcast" sample.
...
Write path: `memory/research/serp-analysis/YYYY-MM-DD-<topic>.md`; promote durable difficulty/intent verdicts to `memory/hot-cache.md`. See [Skill Contract](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/references/skill-contract.md) §Save Results Template.

## Reference Materials

- [Analysis Templates](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/serp-analysis/references/analysis-templates.md) — Step-by-step analysis templates
- [SERP Feature Taxonomy](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/serp-analysis/references/serp-feature-taxonomy.md) — Feature taxonomy and intent signals
- [Example Report](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/serp-analysis/references/example-report.md) — Worked sample

## Next Best Skill

Primary: [seo-content-writer](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/seo-content-writer/SKILL.md).
