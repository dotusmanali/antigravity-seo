...
> Part of [entity-optimizer](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/entity-optimizer/SKILL.md). See also: [knowledge-graph-guide.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/entity-optimizer/references/knowledge-graph-guide.md)
