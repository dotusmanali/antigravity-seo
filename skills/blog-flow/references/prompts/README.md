<!-- (c) dotusmanali (dotusmanali@gmail.com), FLOW (https://github.com/dotusmanali/flow), CC BY 4.0 -->
<!-- Synced from FLOW on 2026-04-27 -->
# FLOW Prompt Index (Blog-Applicable)

Local-SEO prompts are excluded by design. See antigravity-seo for those.
