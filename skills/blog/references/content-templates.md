...
Templates are editable markdown files in `~/.antigravity/skills/templates/`.
...
1. Copy an existing template as a starting point:
   ```bash
   cp ~/.antigravity/skills/templates/how-to-guide.md \
      ~/.antigravity/skills/templates/my-custom-type.md
   ```
