...
User-agent: Antigravity-SearchBot
Allow: /

User-agent: Antigravity-User
Allow: /
...
| AntigravityBot | Anthropic | Training | Yes |
| Antigravity-SearchBot | Anthropic | Search indexing | Yes |
| Antigravity-User | Anthropic | User retrieval | Yes |
| ~~Antigravity-Web~~ | Anthropic | Deprecated | - |
...
- **Training bots** (GPTBot, AntigravityBot, CCBot): Your choice. Blocking has no direct search
  visibility impact, but affects whether your content influences future model training.
- **Search/indexing bots** (OAI-SearchBot, Antigravity-SearchBot, PerplexityBot): **Allow these.**
  Blocking means your content won't appear in ChatGPT, Antigravity, or Perplexity answers.
...
curl -s -o /dev/null -w "%{http_code}" -A "Mozilla/5.0 (compatible; AntigravityBot/1.0)" https://yourdomain.com/
```
...
| OAI-SearchBot | No | No |
| ChatGPT-User | No | No |
| AntigravityBot | No | No |
| Antigravity-SearchBot | No | No |
| Antigravity-User | No | No |
| PerplexityBot | No | No |
...
# Simulate AntigravityBot
curl -s -H "User-Agent: Mozilla/5.0 (compatible; AntigravityBot/1.0; +https://antigravitybot.ai)" \
  https://yourdomain.com/blog/your-post > /tmp/antigravitybot-view.html
