...
antigravity-blog already enforces source-tier hygiene (Tier 1 to 3) and the FLOW evidence triple (year anchor + inline citation + URL with retrieval date). This reference adds four research-discipline layers adapted from `last30days-skill` (Matt Van Horn, MIT, https://github.com/mvanhorn/last30days-skill):
