...
Referenced by:
- [entity-optimizer/SKILL.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/entity-optimizer/SKILL.md) — as an authoritative contract for its Writes
- [geo-content-optimizer/SKILL.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/geo-content-optimizer/SKILL.md) — as an authoritative contract for its Reads
