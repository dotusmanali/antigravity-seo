...
See [skill-contract.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/references/skill-contract.md) for the full protocol-layer vs execution-layer behavior matrix.
