...
Use ~~analytics, ~~search console, and ~~SEO tool when connected; otherwise ask for traffic data, ranking history, publish dates, candidate URLs, and competitor examples. See [CONNECTORS.md](https://github.com/dotusmanali/antigravity-seo/blob/main/CONNECTORS.md).
...
1. **CORE-EEAT Quick Score** — Estimate all 8 dimensions, prioritize red/yellow areas, and hand off to [content-quality-auditor](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/content-quality-auditor/SKILL.md) for full scoring when needed.
...
> **Reference**: [references/refresh-templates.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/content-refresher/references/refresh-templates.md) has compact templates for steps 2-9.

## Decision Gates

**Stop and ask the user when:**
- A page is decayed enough that a rewrite may beat a refresh (e.g., outdated premise, intent shift, or >50% of content stale) — state the finding and ask: (1) refresh in place, or (2) rewrite as new content via [seo-content-writer](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/seo-content-writer/SKILL.md).
...
- A request to "refresh" content that is actually net-new (no existing URL) — note the mismatch once and route to [seo-content-writer](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/seo-content-writer/SKILL.md) rather than fabricating a prior version.
...
> **Reference**: See [references/refresh-example.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/content-refresher/references/refresh-example.md) for the full worked example and checklist.
...
> **Reference data**: [references/content-decay-signals.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/content-refresher/references/content-decay-signals.md) covers decay signals, lifecycle stages, refresh-vs-rewrite decisions, and content-type strategy.
...
- [Content Decay Signals](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/content-refresher/references/content-decay-signals.md) — Decay indicators, lifecycle stages, and refresh triggers by content type
- [Refresh Templates](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/content-refresher/references/refresh-templates.md) — Compact templates for steps 2-9
- [Refresh Example & Checklist](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/content-refresher/references/refresh-example.md) — Full worked example and pre/post-refresh checklist

## Next Best Skill

Primary: [content-quality-auditor](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/content-quality-auditor/SKILL.md) — re-score refreshed content before shipping.
