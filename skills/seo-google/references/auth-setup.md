...
3. Name it (e.g., "Antigravity SEO") and note the project ID
...
```json
{
  ...
  "client_email": "antigravity-seo@your-project.iam.gserviceaccount.com",
  "client_id": "...",
...
Credential Tier: 2 -- Full (API key + Service Account + GA4)
  ...
  [OK] Google Search Console API
       Service account: antigravity-seo@your-project.iam.gserviceaccount.com
