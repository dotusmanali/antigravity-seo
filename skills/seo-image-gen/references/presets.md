...
When a preset is active, Antigravity uses its values as defaults for the Reasoning Brief:
...
# Create interactively (Antigravity fills in details from conversation)
