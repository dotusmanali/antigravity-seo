...
> Based on [CITE Domain Rating](https://github.com/dotusmanali/cite-domain-rating). Full benchmark reference: [references/cite-domain-rating.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/references/cite-domain-rating.md)
...
**Sister skill**: [content-quality-auditor](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/content-quality-auditor/SKILL.md) evaluates content at the page level (80 items). This skill evaluates the domain behind the content (40 items). Together they provide a complete 120-item assessment.
...
Start with one of these prompts. Finish with a citation-trust verdict and a handoff summary using the repository format in [Skill Contract](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/references/skill-contract.md).
...
> See [CONNECTORS.md](https://github.com/dotusmanali/antigravity-seo/blob/main/CONNECTORS.md) for tool category placeholders.
...
If any critical trust check triggers, flag it prominently at the top of the report using plain language. CITE Score is capped per [Runbook §2](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/references/auditor-runbook.md).

### Step 2: C + I Audit (20 items)

Evaluate each item against the criteria in [references/cite-domain-rating.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/references/cite-domain-rating.md).
...
Non-auditor skill handoffs follow [skill-contract.md §Handoff Summary Format](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/references/skill-contract.md) as-is. Cap-related fields do not apply. Non-auditors never emit `cap_applied` / `raw_overall_score` / `final_overall_score`, and MUST NOT use the `class: auditor-output` frontmatter marker.
...
**Veto items**:
- CORE-EEAT: T04, C01, R10 — see [core-eeat-benchmark.md §Veto Items](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/references/core-eeat-benchmark.md)
- CITE: T03, T05, T09 — see [cite-domain-rating.md §Veto Items](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/references/cite-domain-rating.md)
...
Before rendering to the user, translate internal language. This respects [skill-contract.md §Response Presentation Norms](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/references/skill-contract.md) which forbids internal jargon in user output.
...
This is a **restatement for readability** — the authoritative rule lives in [references/auditor-runbook.md §1](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/references/auditor-runbook.md). If this text drifts from §1 source, Runbook wins.
...
- For tracking progress: run `/seo:track --report` with CITE score trends
```
...
See [Example Report](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/domain-authority-auditor/references/example-report.md) for a complete CITE audit of cloudhosting.com showing veto check, dimension scores, top 5 improvements, action plan, and cross-reference with CORE-EEAT.
...
- [CITE Domain Rating](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/references/cite-domain-rating.md) — Full 40-item benchmark with dimension definitions, scoring criteria, domain-type weight tables, and veto items
- [references/example-report.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/domain-authority-auditor/references/example-report.md) — Complete CITE audit example with scored dimensions, top 5 improvements, action plan, and CORE-EEAT cross-reference

## Next Best Skill

CAUTIOUS + link-quality: [backlink-analyzer](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/backlink-analyzer/SKILL.md). UNTRUSTED: [entity-optimizer](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/entity-optimizer/SKILL.md). TRUSTED: terminal. Visited-set rule applies per [skill-contract.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/references/skill-contract.md).
