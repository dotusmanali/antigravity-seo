...
Full example audit output for reference. See the [SKILL.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/domain-authority-auditor/SKILL.md) for the complete workflow.
...
**Diagnosis**: Low CITE + unknown CORE-EEAT → Run `/seo:audit` on top 5 landing pages to determine whether to prioritize content quality or domain authority first.
...
- For tracking progress: run `/seo:track --report` with CITE score trends quarterly
```
