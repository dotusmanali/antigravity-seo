...
description: >
  ...
  visualizations. Optionally executes content creation if antigravity-blog is installed.
...
| `/seo cluster execute` | Execute plan: create content via antigravity-blog or output briefs |
...
```
Test: Does ~/.gemini/skills/blog/SKILL.md exist?
```
...
4. Inform user: "Install [antigravity-blog](https://github.com/dotusmanali/antigravity-blog)
...
| `cluster-briefs/` | Content briefs (if no antigravity-blog) |
...
| "antigravity-blog not installed" | Execute attempted without blog skill | Generate content briefs instead; suggest installation |
