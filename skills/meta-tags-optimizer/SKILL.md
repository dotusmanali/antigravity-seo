...
- **Primary next skill**: [schema-markup-generator](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/schema-markup-generator/SKILL.md) when the metadata package is ready for structured-data support.
...
Optional search console and SEO tool integrations pull CTR data and competitor patterns automatically; otherwise ask for current tags, keywords, and competitors. See [CONNECTORS.md](https://github.com/dotusmanali/antigravity-seo/blob/main/CONNECTORS.md).
...
> **Reference**: See [Instructions Detail](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/meta-tags-optimizer/references/instructions-detail.md) for the compact workflow, formulas, alignment matrix, CTR analysis, and example. See [Meta Tag Code Templates](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/meta-tags-optimizer/references/meta-tag-code-templates.md) for HTML blocks.

## Example

Sample outcome: a 55-character title, a 150-160 character description, and a complete OG / Twitter / Article tag block. See the full worked sample in [Instructions Detail — Example](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/meta-tags-optimizer/references/instructions-detail.md#example).
...
- [Instructions Detail](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/meta-tags-optimizer/references/instructions-detail.md) — Workflow, formulas, alignment matrix, example
- [Meta Tag Formulas](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/meta-tags-optimizer/references/meta-tag-formulas.md) — Title and description formulas
- [Meta Tag Code Templates](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/meta-tags-optimizer/references/meta-tag-code-templates.md) — HTML templates
- [CTR and Social Reference](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/meta-tags-optimizer/references/ctr-and-social-reference.md) — CTR patterns and social guidance

## Next Best Skill

- **Primary**: [schema-markup-generator](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/schema-markup-generator/SKILL.md) — complete the SERP package with structured data.
