...
> **Reference**: See [references/meta-tag-code-templates.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/meta-tags-optimizer/references/meta-tag-code-templates.md) for HTML templates and the complete combined block.
