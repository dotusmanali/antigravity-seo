...
> **Reference**: See [references/example-report.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/keyword-research/references/example-report.md) for the full report template and example.
