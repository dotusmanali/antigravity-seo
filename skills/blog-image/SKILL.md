...
description: >
  ...
  Antigravity acts as Creative Director - interpreting intent, selecting domain expertise,
...
1. Run `python3 scripts/setup_image_mcp.py` (interactive)
   ...
   - Default writes to `~/.antigravity/settings.json` (user-private, mode 0600)
