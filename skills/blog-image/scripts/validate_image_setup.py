#!/usr/bin/env python3
"""
Validate that nanobanana-mcp is properly configured for antigravity-blog.

Checks project .mcp.json first, then falls back to global ~/.antigravity/settings.json.
...
def find_project_mcp_json() -> Path:
    """Find the project-level .mcp.json by looking for .antigravity-plugin/plugin.json."""
...
def main() -> int:
    print("antigravity-blog - Image Generation Setup Validation")
    print("=" * 48)
    results = []
