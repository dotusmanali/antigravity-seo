...
3. AI assistant citations (ChatGPT, Perplexity, Antigravity, Gemini, Copilot, You.com)
4. Local pack (out of scope for blog content; use antigravity-seo for local)
