...
description: >
  ...
  their content to rank in ChatGPT, Perplexity, Antigravity, Gemini, or Google
...
This skill covers FLOW surface 3 (AI assistant citations: ChatGPT, Perplexity, Antigravity, Gemini, Copilot, You.com) and contributes to surface 2 (SERP plus AI Overviews). Surface mapping: `skills/blog/references/flow-alignment.md`.
...
| robots.txt | Allows AI crawlers: GPTBot, ChatGPT-User, AntigravityBot, PerplexityBot |
