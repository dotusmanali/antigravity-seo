...
- **Primary next skill**: [content-quality-auditor](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/content-quality-auditor/SKILL.md) when the draft is ready for gating.
...
Use `~~SEO tool` and `~~search console` when connected; otherwise ask for keywords, intent, and competitors. See [CONNECTORS.md](https://github.com/dotusmanali/antigravity-seo/blob/main/CONNECTORS.md).
...
> **Reference**: See [Instructions Detail](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/seo-content-writer/references/instructions-detail.md) for the compact workflow, pre-write checklist, issue-classification rules, and self-check format.

## Example

Sample outcome: a keyword-led H1, optimized meta description, clear H2 structure, FAQ section, and a brief Changes Made block after the self-check. See [references/seo-writing-checklist.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/seo-content-writer/references/seo-writing-checklist.md) for the copy-start checklist and article template.

## Content Type Templates

Quick-start patterns for how-to guides, comparisons, listicles, pillar pages, reviews, and FAQ pages live in [references/content-structure-templates.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/seo-content-writer/references/content-structure-templates.md).
...
- [Instructions Detail](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/seo-content-writer/references/instructions-detail.md) — Workflow, CORE-EEAT constraints, issue handling, self-check
- [SEO Writing Checklist](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/seo-content-writer/references/seo-writing-checklist.md) — On-page checklist, snippet patterns, and copy-start template
- [Title Formulas](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/seo-content-writer/references/title-formulas.md) — Headline formulas and CTR patterns
- [Content Structure Templates](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/seo-content-writer/references/content-structure-templates.md) — Compact content blueprints

## Next Best Skill

- **Primary**: [content-quality-auditor](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/content-quality-auditor/SKILL.md) — gate the draft before publishing.
