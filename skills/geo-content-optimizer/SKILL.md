...
See [AI Overview Recovery](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/geo-content-optimizer/references/ai-overview-recovery.md) for the 4-phase playbook (measure → diagnose → rewrite → monitor) tailored to recovery scenarios (as opposed to generic GEO optimization).
...
Use `~~AI monitor` and `~~SEO tool` when connected; otherwise ask for target queries, content, engines, competitor examples, and known AI-citation gaps. See [CONNECTORS.md](https://github.com/dotusmanali/antigravity-seo/blob/main/CONNECTORS.md).
...
> **Reference**: See [Instructions Detail](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/geo-content-optimizer/references/instructions-detail.md) for the full CORE-EEAT GEO target tables, AI engine preferences, analysis templates, optimization report template, self-check matrix, and examples.
...
**Output** adds a clear definition, dated/source-backed facts, structured list, quotable statements, and a before/after GEO score. See the full pattern in [Instructions Detail — Example](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/geo-content-optimizer/references/instructions-detail.md#example).

## GEO Optimization Checklist

> **Reference**: See the GEO Readiness Checklist in [GEO Optimization Techniques](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/geo-content-optimizer/references/geo-optimization-techniques.md) for the full checklist covering definitions, quotable content, authority, structure, and technical elements.

## Tips for Success

Answer first, be specific, cite dated sources, stay current, match query format, and build authority. Full list in [Instructions Detail — Tips for Success](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/geo-content-optimizer/references/instructions-detail.md#tips-for-success).
...
- [Instructions Detail](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/geo-content-optimizer/references/instructions-detail.md) - Full 5-step workflow, CORE-EEAT GEO targets, self-check matrix, worked example, tips
- [GEO Optimization Techniques](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/geo-content-optimizer/references/geo-optimization-techniques.md) - Detailed before/after examples, templates, and checklists for each technique
- [AI Citation Patterns](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/geo-content-optimizer/references/ai-citation-patterns.md) - How Google AI Overviews, ChatGPT, Perplexity, and Claude select and cite sources
- [Quotable Content Examples](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/geo-content-optimizer/references/quotable-content-examples.md) - Before/after examples of content optimized for AI citation

## Next Best Skill

- **Primary**: [content-quality-auditor](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/content-quality-auditor/SKILL.md) — verify the optimized content is strong enough to ship and cite.
