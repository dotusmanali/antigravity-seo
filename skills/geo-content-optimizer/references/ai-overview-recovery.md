...
Referenced from [SKILL.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/geo-content-optimizer/SKILL.md). Use when AI Overviews are diverting traffic away from your pages.
...
- [entity-optimizer](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/entity-optimizer/SKILL.md)
- [content-refresher](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/content-refresher/SKILL.md)
- [technical-seo-checker LLM crawler guide](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/technical-seo-checker/references/llm-crawler-handling.md)
