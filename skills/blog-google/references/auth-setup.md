...
3. Name it (e.g., "Antigravity Blog") and note the project ID
...
2. Name: `antigravity-blog` (or similar)
3. Skip optional permissions steps
4. Click on the created service account > **Keys > Add Key > Create new key > JSON**
5. Download and store securely (e.g., `~/.config/antigravity-seo/service_account.json`)
...
4. Store at `~/.config/antigravity-seo/oauth_client.json`
...
Config is shared with antigravity-seo at `~/.config/antigravity-seo/google-api.json`:
