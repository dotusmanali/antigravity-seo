...
- **Primary next skill**: [performance-reporter](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/performance-reporter/SKILL.md) when alert output needs a reporting cadence.
...
All integrations optional (see [CONNECTORS.md](https://github.com/dotusmanali/antigravity-seo/blob/main/CONNECTORS.md)). With tools, monitor real-time feeds from ~~SEO tool, ~~search console, and ~~web crawler. Without tools, ask for baselines, critical keywords, preferences, and historical data.
...
> **Reference**: See [Alert Configuration Templates](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/alert-manager/references/alert-configuration-templates.md) for the full category tables, thresholds, and response-plan templates.
...
> **Reference**: See [Alert Threshold Guide](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/alert-manager/references/alert-threshold-guide.md) for threshold setting, fatigue prevention, escalation paths, and response playbooks.

### Save Results

Ask "Save these results?" If yes, write to `memory/monitoring/` — see [Skill Contract](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/references/skill-contract.md) §Save Results Template.

## Reference Materials

- [Alert Threshold Guide](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/alert-manager/references/alert-threshold-guide.md) — Thresholds, fatigue prevention, and escalation templates

## Next Best Skill

Reporting cadence requested → [performance-reporter](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/performance-reporter/SKILL.md). Standalone setup → Terminal. Visited-set rule applies per [skill-contract.md](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/references/skill-contract.md).
