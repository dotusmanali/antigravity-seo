...
When a user requests a performance report, use [Report Output Templates](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/performance-reporter/references/report-output-templates.md) and cover:
...
- [Report Output Templates](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/performance-reporter/references/report-output-templates.md) — Compact starter blocks for all 11 report sections
- [KPI Definitions](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/performance-reporter/references/kpi-definitions.md) — SEO/GEO metric definitions with benchmarks, thresholds, trend analysis, and attribution guidance
- [Report Templates by Audience](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/performance-reporter/references/report-templates.md) — Copy-ready templates for executive, marketing, technical, and client audiences

## Next Best Skill

Recurring monitoring needed → [alert-manager](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/alert-manager/SKILL.md) — turn reporting insights into ongoing monitoring rules. One-off report → Terminal. Visited-set rule applies per [Skill Contract](https://github.com/dotusmanali/antigravity-seo/blob/main/skills/references/skill-contract.md).
