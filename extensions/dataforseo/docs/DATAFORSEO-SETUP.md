...
Step-by-step guide to getting DataForSEO API credentials for the Antigravity SEO extension.
...
If the installer's auto-configuration fails, add this to `~/.gemini/settings.json`:
  ...
  "mcpServers": {
    "dataforseo": {
      ...
      "env": {
        ...
        "FIELD_CONFIG_PATH": "/home/youruser/.gemini/skills/seo/dataforseo-field-config.json"
      }
    }
  }
}
...
After installing, start Antigravity and run:
