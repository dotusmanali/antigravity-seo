# DataForSEO Extension for Antigravity SEO
...
- [Antigravity SEO](https://github.com/dotusmanali/antigravity-seo) installed
- Node.js 20+
...
3. Configure the MCP server in `~/.gemini/settings.json`
...
## Integration with Antigravity SEO

When installed, other Antigravity SEO skills automatically detect DataForSEO availability and use live data:
...
- [Antigravity SEO](https://github.com/dotusmanali/antigravity-seo)
