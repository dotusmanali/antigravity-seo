...
Checks:
1. Antigravity settings.json has the MCP entry
...
def main() -> int:
    if "--help" in sys.argv or "-h" in sys.argv:
        ...
        print()
        print("Validates Antigravity settings, nanobanana-mcp configuration, npx availability,")
    ...
    results.append(check(
        "Antigravity settings.json exists",
