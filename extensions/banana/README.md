# Banana Image Generation Extension for Antigravity SEO
...
- **Antigravity SEO** installed (`~/.gemini/skills/seo/`)
- **Node.js 18+** with npx
...
Antigravity acts as a **Creative Director**. It never passes raw text to the API.
...
After every generation, Antigravity provides:
